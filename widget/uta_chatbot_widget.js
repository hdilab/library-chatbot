	...
	return function(t) {
		...
		*/
		...
		function v(t, e) {
			...
			if (e.singleton) {
				var a = c++;
				n = u || (u = y(e)), r = w.bind(null, n, a, !1), o = w.bind(null, n, a, !0)
		...
		var C = {
			...
			enqueueUpdate: function t(e) {
				y(), m.isBatchingUpdates ? (f.push(e), null == e._updateBatchNumber && (e._updateBatchNumber = p + 1)) : m.batchedUpdates(t, e)
			},
		...
		function w(t) {
			...
			return function(e) {
				...
				var n = e.displayName || e.name || "Component",
					...
					a = function(n) {
						function a(t, e) {
							...
							return r.version = S, r.state = {}, r.renderCount = 0, r.store = t[E] || e[E], r.propsMode = Boolean(t[E]), r.setWrappedInstance = r.setWrappedInstance.bind(r), h()(r.store, 'Could not find "' + E + '" in either the context or props of "' + o + '". Either wrap the root component in a <Provider>, or explicitly pass "' + E + '" as a prop to "' + o + '".'), r.initSelector(), r.initSubscription(), r
						}
						return function(t, e) {
							if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
							t.prototype = Object.create(e && e.prototype, {
							...
							var e = g({}, t);
							return x && (e.ref = this.setWrappedInstance), d && (e[d] = this.renderCount++), this.propsMode && this.subscription && (e[A] = this.subscription), e
				...
				return a.WrappedComponent = e, a.displayName = o, a.childContextTypes = I, a.contextTypes = T, a.propTypes = T, f()(a, e)
			}
		}
		...
		function j(t, e, n, r, o) {
			...
			function d(o, u) {
				var d, m, y = !a(u, l),
					g = !i(o, c);
				return c = o, l = u, y && g ? (f = t(c, l), e.dependsOnOwnProps && (p = e(r, l)), h = n(f, p, l)) : y ? (t.dependsOnOwnProps && (f = t(c, l)), e.dependsOnOwnProps && (p = e(r, l)), h = n(f, p, l)) : g ? (d = t(c, l), m = !s(d, f), f = d, m && (h = n(f, p, l)), h) : h
			}
			return function(o, i) {
				return u ? d(o, i) : (f = t(c = o, l = i), p = e(r, l), h = n(f, p, l), u = !0, h)
			}
		}
		...
		var r = n(3),
			o = n(17),
			i = (n(2), n(131), Object.prototype.hasOwnProperty),
			a = n(130),
			s = {
				key: !0,
				ref: !0,
		...
		l.createElement = function(t, e, n) {
			...
			if (1 === y) p.children = n;
				...
				for (var g = Array(y), v = 0; v < y; v++) g[v] = arguments[v + 2];
				p.children = g
			}
		...
		(function(r) {
			function o() {
				...
				return !t && void 0 !== r && "env" in r && (t = r.env.DEBUG), t
			}(e = t.exports = n(162)).log = function() {
				return "object" == typeof console && console.log && Function.prototype.apply.call(console.log, console, arguments)
			}, e.formatArgs = function(t) {
				var n = this.useColors;
				if (t[0] = (n ? "%c" : "") + this.namespace + (n ? " %c" : " ") + t[0] + (n ? "%c " : " ") + "+" + e.humanize(this.diff), !n) return;
		...
		t.exports = function() {
			...
			z.prototype.toString = function() {
				...
				return this
			}, V.isSeq = ot, V.Keyed = Q, V.Set = K, V.Indexed = G;
			...
			function ut(t) {
				return W(t) ? new tt(t) : Y(t) ? new rt(t) : F(t) ? new nt(t) : void 0
			}
			...
			function pt(t) {
				return Array.isArray(t) ? G(t).map(pt).toList() : ht(t) ? Q(t).map(pt).toMap() : t
			}
			...
			V.prototype[$] = !0, e(tt, G), tt.prototype.get = function(t, e) {
				...
				var n = this.size;
				return S(t, e, n) ? this : new yt(this._value, I(e, n) - T(t, n))
				...
				return t instanceof yt ? dt(this._value, t._value) : mt(t)
				...
				return S(t, e, this.size) ? this : (t = T(t, this.size), (e = I(e, this.size)) <= t ? new vt(0, 0) : new vt(this.get(t, this._end), this.get(e, this._end), this._step))
			...
			function xt(t) {
				...
				if ("string" === r) return t.length > Dt ? (void 0 === (n = Rt[e = t]) && (n = kt(e), jt === Pt && (jt = 0, Rt = {}), jt++, Rt[e] = n), n) : kt(t);
				if ("function" == typeof t.hashCode) return t.hashCode();
				if ("object" === r) return function(t) {
					var e;
					if (It && void 0 !== (e = At.get(t))) return e;
			...
			Yt[Ft] = !0, Yt.delete = Yt.remove, Yt.removeIn = Yt.deleteIn, qt.prototype.get = function(t, e, n, r) {
				...
				var f = c < l;
				if (f ? u[c][1] === o : s) return this;
				if (C(a), (s || !f) && C(i), s && 2 === l) return new Qt(t, this.keyHash, u[1 ^ c]);
				var p = t && t === this.ownerID,
					h = p ? u : M(u);
				return f ? s ? c === l - 1 ? h.pop() : h[c] = h.pop() : h[c] = [r, o] : h.push([r, o]), p ? (this.entries = h, this) : new Vt(t, this.keyHash, h)
			...
			function pe(t) {
				...
				var n = o(t),
					r = n.size;
				return 0 === r ? e : (Lt(r), r > 0 && r < y ? we(0, r, m, null, new ye(n.toArray())) : e.withMutations(function(t) {
			...
			e(pe, wt), pe.of = function() {
				...
				return function(t, e, n) {
					...
					var r = t._tail,
						o = t._root,
						i = w(_);
					return e >= Se(t._capacity) ? r = Ee(r, t.__ownerID, 0, e, n, i) : o = Ee(o, t.__ownerID, t._level, e, n, i), i.value ? t.__ownerID ? (t._root = o, t._tail = r, t.__hash = void 0, t.__altered = !0, t) : we(t._origin, t._capacity, t._level, o, r) : t
				}(this, t, e)
			...
			me[de] = !0, me.delete = me.remove, me.setIn = Yt.setIn, me.deleteIn = me.removeIn = Yt.removeIn, me.update = Yt.update, me.updateIn = Yt.updateIn, me.mergeIn = Yt.mergeIn, me.mergeDeepIn = Yt.mergeDeepIn, me.withMutations = Yt.withMutations, me.asMutable = Yt.asMutable, me.asImmutable = Yt.asImmutable, me.wasAltered = Yt.wasAltered, ye.prototype.removeBefore = function(t, e, n) {
			...
			function xe(t, e) {
				...
				if (e < 1 << t._level + m) {
					for (var n = t._root, r = t._level; n && r > 0;) n = n.array[e >>> r & g], r -= m;
					return n
				}
			}
			...
			function ke(t, e, n) {
				...
				l && (a += l, o += l, s += l, i += l);
				for (var f = Se(i), p = Se(s); p >= 1 << u + m;) c = new ye(c && c.array.length ? [c] : [], r), u += m;
				var h = t._tail,
					d = p < f ? xe(t, s - 1) : p > f ? new ye([], r) : h;
				if (h && p > f && a < i && h.array.length) {
					for (var y = c = Me(c, r), v = u; v > m; v -= m) {
						var b = f >>> v & g;
						y = y.array[b] = Me(y.array[b], r)
					}
					y.array[f >>> m & g] = h
				}
			...
			function Te(t) {
				return null === t || void 0 === t ? Oe() : Ie(t) ? t : Oe().withMutations(function(e) {
					var n = r(t);
					Lt(n.size), n.forEach(function(t, n) {
						return e.set(n, t)
					})
			...
			function Ye(t, e, n, r) {
				var o = t.size;
				if (void 0 !== e && (e |= 0), void 0 !== n && (n === 1 / 0 ? n = o : n |= 0), S(e, n, o)) return t;
				var i = T(e, o),
					a = I(n, o);
				...
				return c.size = 0 === s ? s : t.size && s || void 0, !r && ot(t) && s >= 0 && (c.get = function(e, n) {
					return (e = k(this, e)) >= 0 && e < s ? t.get(e + i, n) : n
			...
			}, Te.isOrderedMap = Ie, Te.prototype[d] = !0, Te.prototype.delete = Te.prototype.remove, e(Pe, Q), Pe.prototype.get = function(t, e) {
			...
			pn[fn] = !0, pn.delete = pn.remove, pn.mergeDeep = pn.merge, pn.mergeDeepWith = pn.mergeWith, pn.withMutations = Yt.withMutations, pn.asMutable = Yt.asMutable, pn.asImmutable = Yt.asImmutable, pn.__empty = mn, pn.__make = dn, e(yn, un), yn.of = function() {
				return this(arguments)
			...
			function Cn(t) {
				return null === t || void 0 === t ? Sn() : En(t) ? t : Sn().unshiftAll(t)
			}
			...
			bn[d] = !0, bn.__empty = wn, bn.__make = _n, e(Cn, wt), Cn.of = function() {
				...
				return this.__ownerID ? (this.size = t, this._head = e, this.__hash = void 0, this.__altered = !0, this) : An(t, e)
				...
				}), this.__ownerID ? (this.size = e, this._head = n, this.__hash = void 0, this.__altered = !0, this) : An(e, n)
				...
				return 0 === this.size ? this : this.__ownerID ? (this.size = 0, this._head = void 0, this.__hash = void 0, this.__altered = !0, this) : Sn()
				...
				return this.__ownerID ? (this.size = o, this._head = i, this.__hash = void 0, this.__altered = !0, this) : An(o, i)
			}, Cn.prototype.__ensureOwner = function(t) {
				return t === this.__ownerID ? this : t ? An(this.size, this._head, t, this.__hash) : (this.__ownerID = t, this.__altered = !1, this)
			...
			kn[xn] = !0, kn.withMutations = Yt.withMutations, kn.asMutable = Yt.asMutable, kn.asImmutable = Yt.asImmutable, kn.wasAltered = Yt.wasAltered, n.Iterator = z, Tn(n, {
				toArray: function() {
					Lt(this.size);
			...
			var In = n.prototype;
			In[f] = !0, In[L] = In.values, In.__toJS = In.toArray, In.__toStringMapper = Rn, In.inspect = In.toSource = function() {
				return this.toString()
			}, In.chain = In.flatMap, In.contains = In.includes, Tn(r, {
				flip: function() {
			...
			return Nn[p] = !0, Nn[L] = In.entries, Nn.__toJS = In.toObject, Nn.__toStringMapper = function(t, e) {
			...
			}), i.prototype.has = In.includes, i.prototype.contains = i.prototype.includes, Tn(Q, r.prototype), Tn(G, o.prototype), Tn(K, i.prototype), Tn(_t, r.prototype), Tn(wt, o.prototype), Tn(Ct, i.prototype), {
				Iterable: n,
				Seq: V,
				Collection: bt,
				Map: zt,
		...
		t.exports = function(t, e) {
			...
			return function(t, e) {
				var n, i, a, p, A, S, T, I, N, O, D, P, j, R, L, z, U, B, F, Y = e.additional,
					q = e.nonTerminated,
					H = e.text,
					W = e.reference,
					V = e.warning,
					Q = e.textContext,
					G = e.referenceContext,
					K = e.warningContext,
					X = e.position,
					Z = e.indent || [],
					J = t.length,
					...
					rt = "",
					ot = [];
				z = at(), I = V ? function(t, e) {
					var n = at();
					n.column += e, n.offset += e, V.call(K, x[t], n, t)
				} : f, $--, J++;
				for (; ++$ < J;)
					if ("\n" === A && (et = Z[tt] || 1), "&" !== (A = st($))) "\n" === A && (nt++, tt++, et = 0), A ? (rt += A, et++) : ut();
					else {
						if ("\t" === (T = st($ + 1)) || "\n" === T || "\f" === T || " " === T || "<" === T || "&" === T || "" === T || Y && T === Y) {
							rt += A, et++;
							continue
						}
						for (P = j = $ + 1, F = j, "#" !== T ? R = h : (F = ++P, "x" === (T = st(F)) || "X" === T ? (R = d, F = ++P) : R = m), n = "", D = "", p = "", L = g[R], F--; ++F < J && (T = st(F), L(T));) p += T, R === h && c.call(r, p) && (n = p, D = r[p]);
						(a = ";" === st(F)) && (F++, (i = R === h && u(p)) && (n = p, D = i)), B = 1 + F - j, (a || q) && (p ? R === h ? (a && !D ? I(C, 1) : (n !== p && (F = P + n.length, B = 1 + F - P, a = !1), a || (N = n ? v : _, e.attribute ? "=" === (T = st(F)) ? (I(N, B), D = null) : s(T) ? D = null : I(N, B) : I(N, B))), S = D) : (a || I(b, B), S = parseInt(p, y[R]), (it = S) >= 55296 && it <= 57343 || it > 1114111 ? (I(M, B), S = "Ã¯Â¿Â½") : S in o ? (I(E, B), S = o[S]) : (O = "", k(S) && I(E, B), S > 65535 && (O += l((S -= 65536) >>> 10 | 55296), S = 56320 | 1023 & S), S = O + l(S))) : R !== h && I(w, B)), S ? (ut(), z = at(), $ = F - 1, et += F - j + 1, ot.push(S), (U = at()).offset++, W && W.call(G, S, {
							start: z,
							end: U
						}, t.slice(j - 1, F)), z = U) : (p = t.slice(j - 1, F), rt += p, et += p.length, $ = F - 1)
					}
				var it;
				return ot.join("");
		...
		var c = function(t) {
			...
			return function(t, e) {
				...
				key: "render",
				value: function() {
					var t = this.props.message.get("sender"),
						e = this.props.message.get("text");
					return i.default.createElement("div", {
						className: t
					}, i.default.createElement("div", {
						className: "message-text"
					}, "response" === t ? i.default.createElement(a.default, {
						className: "markdown",
						source: e
					}) : e))
				}
				...
				recordOf: function(t) {
					return s(function(e, n, o, i, s) {
						...
						for (var d in t) {
							...
							if (m) {
								var y = f.toObject(),
									g = m.apply(void 0, [y, d, o, i, s + "." + d].concat(c));
								if (g) return g
							}
						}
					})
		...
		function c(t, e, n) {
			return s(function(r, o, i, s, u) {
				...
				for (var m = p.toArray(), y = 0, g = m.length; y < g; y++) {
					var v = t.apply(void 0, [m, y, i, s, u + "[" + y + "]"].concat(l));
			...
			return s(function() {
				...
				return c(t, n, r).apply(void 0, i) || e && (u = e, s(function(t, e, n, r, o) {
					...
					for (var l = c.keySeq().toArray(), f = 0, p = l.length; f < p; f++) {
						var h = u.apply(void 0, [l, f, n, r, o + " -> key(" + l[f] + ")"].concat(a));
		...
		function f(t) {
			...
			return s(function(r, o, i, s, u) {
				...
				for (var m in t) {
					var y = t[m];
					if (y) {
						var g = y.apply(void 0, [d, m, i, s, u + "." + m].concat(l));
						if (g) return g
					}
				}
			})
		...
		function T(t, e, n, r) {
			...
			o.perform(S, null, t, e, o, n, r), y.ReactReconcileTransaction.release(o)
		}
		...
		var R = {
			...
			_renderSubtreeIntoContainer: function(t, e, n, o) {
				...
				var d, y = A(n),
					v = y && !(!(d = y).getAttribute || !d.getAttribute(w)),
					b = N(n),
					C = v && !c && !b,
			...
			unmountComponentAtNode: function(t) {
				...
				return delete k[e._instance.rootID], y.batchedUpdates(I, e, t, !1), !0
			},
		...
		t.exports = function(t, e, n) {
			return null == t ? 0 : function t(e, n, l, f) {
				...
				var d = 0,
					m = "" === n ? s : n + u;
				if (Array.isArray(e))
					for (var y = 0; y < e.length; y++) d += t(p = e[y], m + c(p, y), l, f);
				else {
					var g = i(e);
					if (g) {
						var v, b = g.call(e);
		...
		function o() {
			...
			return !1
		}, e.humanize = n(52), e.instances = [], e.names = [], e.skips = [], e.formatters = {}
	}, function(t, e, n) {
		(function(e) {
		...
		(function(t, r) {
			...
			! function(i) {
				...
				function g(t) {
					...
					if (224 == (240 & e)) {
						if ((n = (15 & e) << 12 | y() << 6 | y()) >= 2048) return h(n, t) ? n : 65533;
						throw Error("Invalid continuation byte")
					}
		...
		(function(e) {
			...
			t.exports = l, l.priorWebsocketSuccess = !1, o(l.prototype), l.protocol = s.protocol, l.Socket = l, l.Transport = n(49), l.transports = n(87), l.parser = n(22), l.prototype.createTransport = function(t) {
		...
		t.exports = n(157), t.exports.parser = n(22)
	}, function(t, e, n) {
		(function(t) {
			var r = n(90),
				o = n(89),
		...
		(function(r) {
			function o() {
				...
				return !t && void 0 !== r && "env" in r && (t = r.env.DEBUG), t
			}(e = t.exports = n(160)).log = function() {
				return "object" == typeof console && console.log && Function.prototype.apply.call(console.log, console, arguments)
			}, e.formatArgs = function(t) {
				var n = this.useColors;
				if (t[0] = (n ? "%c" : "") + this.namespace + (n ? " %c" : " ") + t[0] + (n ? "%c " : " ") + "+" + e.humanize(this.diff), !n) return;
		...
		e.protocol = o.protocol, e.connect = u, e.Manager = n(88), e.Socket = n(82)
	}, function(t, e, n) {
		"use strict";
		Object.defineProperty(e, "__esModule", {
			value: !0
		...
		function i(t, e) {
			...
			var f = function(t, e, n, s, u, c) {
				var l = {
					...
					f = "string" == typeof s;
				n.sourcePos && t.position && (l["data-sourcepos"] = [(p = t.position).start.line, ":", p.start.column, "-", p.end.line, ":", p.end.column].map(String).join(""));
				var p;
				...
				var h = null !== t.identifier && void 0 !== t.identifier ? n.definitions[t.identifier] || {} : null;
				switch (t.type) {
					case "root":
						a(l, {
					...
					case "imageReference":
						a(l, {
							src: n.transformImageUri && h.href ? n.transformImageUri(h.href, t.children, h.title, t.alt) : h.href,
		...
		function a(t, e, n) {
			for (var o, a, s, u, c, l, f, p, h = e.length, d = 0, m = "", y = ""; d < h && e.charAt(d) === i;) m += i, d++;
			if (m) {
				for (c = m, u = d, m = "", p = e.charAt(d), s = 0; d < h;) {
					if (l = p, p = e.charAt(d + 1), l === i ? (s++, y += l) : (s = 0, m += l), s && p !== i) {
						if (s === u) {
							c += m + y, f = !0;
							break
						}
		...
		function c(t, e, n) {
			var a, c, l, f, p, h, d, m = 0,
				y = e.charAt(m);
			if (!(y !== s && y !== u || (c = this.options.pedantic, p = y, l = y, h = e.length, m++, f = "", y = "", c && i(e.charAt(m)))))
				for (; m < h;) {
					if (d = y, !((y = e.charAt(m)) !== l || c && i(d))) {
						if ((y = e.charAt(++m)) !== l) {
							if (!r(f) || d === l) return;
							if (!c && l === u && o(y)) {
								f += l;
		...
		function y(t, e, n) {
			var o, y, g, v, b, _, w, C, E = e.charAt(0),
				M = 0,
				x = e.length,
				k = "",
				A = "",
				S = a,
				T = c;
			if ("!" === E && (S = s, A = E, E = e.charAt(++M)), E === d) {
				if (M++, A += E, _ = "", this.options.footnotes && e.charAt(M) === p) {
					if (S === s) return;
					A += p, M++, S = u
				}
				for (C = 0; M < x;) {
				...
				if (k = _, o = _, (E = e.charAt(M)) === m) {
					for (M++, k += E, _ = ""; M < x && (E = e.charAt(M), r(E));) _ += E, M++;
					if (E = e.charAt(M), S !== u && E === d) {
						for (y = "", _ += E, M++; M < x && (E = e.charAt(M)) !== d && E !== m;) E === h && (y += h, E = e.charAt(++M)), y += E, M++;
						(E = e.charAt(M)) === m ? (T = y ? f : l, _ += y + E, M++) : y = "", k += _, _ = ""
					} else {
						if (!o) return;
						y = o
					}
					if (T === f || !w) return k = A + k, S === a && this.inLink ? null : !!n || (S === u && -1 !== o.indexOf(" ") ? t(k)({
						type: "footnote",
						children: this.tokenizeInline(o, t.now())
					}) : ((g = t.now()).column += A.length, g.offset += A.length, v = {
						type: S + "Reference",
						identifier: i(y = T === f ? y : o)
					}, S !== a && S !== s || (v.referenceType = T), S === a ? (b = this.enterLink(), v.children = this.tokenizeInline(o, g), b()) : S === s && (v.alt = this.decode.raw(this.unescape(o), g) || null), t(k)(v)))
				}
			}
		}
	}, function(t, e, n) {
		...
		function y(t, e, n) {
			var o, y, g, v, b, _, w, C, E, M, x, k, A, S, T, I, N, O, D, P = "",
				j = 0,
				R = e.charAt(0),
			...
			if ("!" === R && (E = !0, P = R, R = e.charAt(++j)), R === s && (E || !this.inLink)) {
				for (P += R, T = "", j++, k = e.length, S = 0, (N = t.now()).column += j, N.offset += j; j < k;) {
					if (_ = R = e.charAt(j), R === h) {
						for (y = 1; e.charAt(j + 1) === h;) _ += R, j++, y++;
						g ? y >= g && (g = 0) : g = y
						...
						if ((!g || U) && R === u) {
							if (!S) {
								if (!L)
									for (; j < k && (R = e.charAt(j + 1), r(R));) _ += R, j++;
				...
				if (o) {
					for (M = T, P += T + _, j++; j < k && (R = e.charAt(j), r(R));) P += R, j++;
					if (R = e.charAt(j), C = z ? m : d, T = "", v = P, R === f) {
						for (j++, v += f; j < k && (R = e.charAt(j)) !== p;) {
							if (z && "\n" === R) return;
							T += R, j++
						}
						...
						for (R = null, _ = ""; j < k && (R = e.charAt(j), !_ || !i.call(C, R));) {
							if (r(R)) {
								if (!L) break;
								_ += R
							} else {
								...
								T += _, _ = "", R === a && (T += a, R = e.charAt(++j)), T += R
							}
							j++
						}
						I = T, j = (P += T).length
					}
					for (T = ""; j < k && (R = e.charAt(j), r(R));) T += R, j++;
					if (R = e.charAt(j), P += T, T && i.call(C, R))
						if (j++, P += R, T = "", x = C[R], b = P, z) {
							for (; j < k && (R = e.charAt(j)) !== x;) R === a && (T += a, R = e.charAt(++j)), j++, T += R;
							if ((R = e.charAt(j)) !== x) return;
							for (A = T, P += T + R, j++; j < k && (R = e.charAt(j), r(R));) P += R, j++
						} else
							for (_ = ""; j < k;) {
								if ((R = e.charAt(j)) === x) w && (T += x + _, _ = ""), w = !0;
								else if (w) {
									if (R === l) {
										P += T + x + _, A = T;
										break
									}
									r(R) ? _ += R : (T += x + _ + R, _ = "", w = !1)
								} else T += R;
								j++
							}
					if (e.charAt(j) === l) return !!n || (P += l, I = this.decode.raw(this.unescape(I), t(v).test().end, {
						nonTerminated: !1
					}), A && (b = t(b).test().end, A = this.decode.raw(this.unescape(A), b)), D = {
						type: E ? "image" : "link",
						title: A || null,
						url: I
		...
		function m(t, e, n) {
			var i, m, y, g, v, b, _, w, C, E, M, x;
			if (this.options.gfm) {
				for (i = "", g = -1, w = d; ++g < w;)
					if (b = h[g], (_ = e.slice(0, b.length)).toLowerCase() === b) {
						i = _;
						break
					}
				if (i) {
					for (g = i.length, w = e.length, C = "", E = 0; g < w && (y = e.charAt(g), !o(y) && y !== l) && ("." !== y && "," !== y && ":" !== y && ";" !== y && '"' !== y && "'" !== y && ")" !== y && "]" !== y || (M = e.charAt(g + 1)) && !o(M)) && (y !== u && y !== a || E++, y !== c && y !== s || !(--E < 0));) C += y, g++;
					if (C) {
						if (m = i += C, b === p) {
		...
		function p(t, e, n) {
			var i, p, h, d, m, y, g, v, b, _, w;
			if (e.charAt(0) === a) {
				for (this, i = "", p = e.length, h = 0, d = "", y = !1, g = "", h++, i = a; h < p && (m = e.charAt(h), !(r(m) || m === s || m === u || ":" === m && e.charAt(h + 1) === c));) d += m, h++;
				if (d) {
					if (g += d, d = "", g += m = e.charAt(h), h++, m === u) y = !0;
					else {
						if (":" !== m || e.charAt(h + 1) !== c) return;
						g += c, h++
					}
					for (; h < p && (m = e.charAt(h), !r(m) && m !== s);) d += m, h++;
					if (m = e.charAt(h), d && m === s) return !!n || (b = g += d, i += g + m, (v = t.now()).column++, v.offset++, y && (g.slice(0, f).toLowerCase() === l ? (b = b.substr(f), v.column += f, v.offset += f) : g = l + g), _ = this.inlineTokenizers, this.inlineTokenizers = {
						text: _.text
		...
		t.exports = function(t, e, n) {
			...
			for (; w < C;) {
				...
				if (b.list.call(this, t, p, !0) && (this.inList || g || v && !o(r.left(p).charAt(0)))) break;
		...
		var r = n(9);
		t.exports = function(t, e, n) {
			var v, b, _, w, C, E, M, x, k, A, S, T, I, N, O, D, P, j, R, L, z, U, B, F;
			...
			w = M.join(l), b = M.splice(1, 1)[0] || [], v = 0, E = b.length, j--, _ = !1, S = [];
			for (; v < E;) {
				if ((k = b.charAt(v)) === s) {
					if (A = null, !1 === _) {
						if (!1 === F) return
					...
					F = !1
				} else if (k === a) A = !0, _ = _ || g;
				else if (k === u) _ = _ === d ? m : A && _ === g ? y : d;
				else if (!r(k)) return;
				v++
			}!1 !== _ && S.push(_);
			...
			for (; ++P < j;) {
				for (R = M[P], C = {
						type: "tableRow",
						children: []
					}, P && t(l), t(R).reset(C, z), E = R.length + 1, v = 0, x = "", T = "", I = !0, N = null, O = null; v < E;)
					if ((k = R.charAt(v)) !== f && k !== c) {
						if ("" === k || k === s)
							if (I) t(k);
							else {
								if (k && O) {
									x += k, v++;
									continue
								}!T && !k || I || (w = T, x.length > 1 && (k ? (w += x.slice(0, x.length - 1), x = x.charAt(x.length - 1)) : (w += x, x = "")), D = t.now(), t(w)({
									type: "tableCell",
									children: this.tokenizeInline(T, D)
								}, C)), t(x + k), x = "", T = ""
							}
						else if (x && (T += x, x = ""), T += k, k === o && v !== E - 2 && (T += R.charAt(v + 1), v++), k === i) {
							for (N = 1; R.charAt(v + 1) === k;) T += k, v++, N++;
							O ? N >= O && (O = 0) : O = N
						}
						I = !1, v++
					} else T ? x += k : t(k), v++;
		...
		function v(t, e, n) {
			for (var r, g, v, w, C, E, M, x, k = this.options.commonmark, A = 0, S = e.length, T = ""; A < S && ((w = e.charAt(A)) === l || w === c);) T += w, A++;
			if ((w = e.charAt(A)) === f) {
				for (A++, T += w, v = ""; A < S && (w = e.charAt(A)) !== p;) w === s && (v += w, A++, w = e.charAt(A)), v += w, A++;
				if (v && e.charAt(A) === p && e.charAt(A + 1) === m) {
					for (E = v, A = (T += v + p + m).length, v = ""; A < S && ((w = e.charAt(A)) === c || w === l || w === u);) T += w, A++;
					if (v = "", r = T, (w = e.charAt(A)) === y) {
						for (A++; A < S && b(w = e.charAt(A));) v += w, A++;
						if ((w = e.charAt(A)) === b.delimiter) T += y + v + w, A++;
						else {
							if (k) return;
							A -= v.length + 1, v = ""
						}
					...
					if (!v) {
						for (; A < S && _(w = e.charAt(A));) v += w, A++;
						T += v
					}
					if (v) {
						for (M = v, v = ""; A < S && ((w = e.charAt(A)) === c || w === l || w === u);) v += w, A++;
						if (C = null, (w = e.charAt(A)) === i ? C = i : w === a ? C = a : w === h && (C = d), C) {
							if (!v) return;
							for (A = (T += v + w).length, v = ""; A < S && (w = e.charAt(A)) !== C;) {
								if (w === u) {
									if (A++, (w = e.charAt(A)) === u || w === C) return;
									v += u
								}
								v += w, A++
							}
							if ((w = e.charAt(A)) !== C) return;
							g = T, T += v + w, A++, x = v, v = ""
						} else v = "", A = T.length;
						for (; A < S && ((w = e.charAt(A)) === c || w === l);) T += w, A++;
						return (w = e.charAt(A)) && w !== u ? void 0 : !!n || (r = t(r).test().end, M = this.decode.raw(this.unescape(M), r, {
							nonTerminated: !1
						}), x && (g = t(g).test().end, x = this.decode.raw(this.unescape(x), g)), t(T)({
							type: "definition",
							identifier: o(E),
							title: x || null,
							url: M
		...
		function d(t, e, n) {
			var d, m, y, g, v, b, _, w, C, E, M, x, k = this.offset;
			if (this.options.footnotes) {
				for (d = 0, m = e.length, y = "", g = t.now(), v = g.line; d < m && (C = e.charAt(d), r(C));) y += C, d++;
				if (e.charAt(d) === c && e.charAt(d + 1) === f) {
					for (d = (y += c + f).length, _ = ""; d < m && (C = e.charAt(d)) !== l;) C === i && (_ += C, d++, C = e.charAt(d)), _ += C, d++;
					if (_ && e.charAt(d) === l && e.charAt(d + 1) === p) {
						if (n) return !0;
						for (E = o(_), d = (y += _ + l + p).length; d < m && ((C = e.charAt(d)) === s || C === u);) y += C, d++;
						for (g.column += y.length, g.offset += y.length, _ = "", b = "", w = ""; d < m;) {
							if ((C = e.charAt(d)) === a) {
						...
						return y += b, b = b.replace(h, function(t) {
							return k[v] = (k[v] || 0) + t.length, v++, ""
						}), M = t(y), x = this.enterBlock(), b = this.tokenizeBlock(b, g), x(), M({
		...
		t.exports = function(t, e, n) {
			...
			for (; g < y && ((f = e.charAt(g)) === o || f === i);) g++;
			if (e.charAt(g) !== s) return;
			u = -1 === (u = e.indexOf(a, g + 1)) ? y : u, c = e.slice(g, u), l = -1, p = v.length;
			for (; ++l < p;)
				if (v[l][0].test(c)) {
					h = v[l];
					break
			...
			if (g = u, !h[1].test(c))
				for (; g < y;) {
					if (u = -1 === (u = e.indexOf(a, g + 1)) ? y : u, c = e.slice(g + 1, u), h[1].test(c)) {
						c && (g = u);
						break
					}
					g = u
				}
			return d = e.slice(0, g), t(d)({
				type: "html",
				value: d
			})
		};
		...
		t.exports = function(t, e, n) {
			...
			if (h.column += y.length, h.offset += y.length, y += u + c, l = e.charAt(++m), f = e.charAt(++m), l !== r || !s[f]) return;
			y += l, c = f, p = s[f];
			for (; ++m < d;) {
				if ((l = e.charAt(m)) !== f) {
					if (l !== r) return;
		...
		var r = n(24),
			...
			u = n(54);
		t.exports = function(t, e, n) {
			var o, a, s, m, g, v, b, _, w, k, A, S, T, I, N, O, D, P, j, R, L, z, U, B, F = this.options.commonmark,
			...
			if (G >= y) return;
			if (m = e.charAt(W), o = F ? M : E, !0 === C[m]) g = m, s = !1;
			else {
				for (s = !0, a = ""; W < V && (m = e.charAt(W), i(m));) a += m, W++;
				if (m = e.charAt(W), !a || !0 !== o[m]) return;
				Q = parseInt(a, 10), g = m
			}
			if ((m = e.charAt(++W)) !== p && m !== d) return;
			if (n) return !0;
			W = 0, I = [], N = [], O = [];
			for (; W < V;) {
				for (v = e.indexOf(h, W), b = W, _ = !1, B = !1, -1 === v && (v = V), U = W + y, G = 0; W < V;) {
					if ((m = e.charAt(W)) === d) G += y - G % y;
					else {
						if (m !== p) break;
						G++
				...
				if (G >= y && (B = !0), D && G >= D.indent && (B = !0), m = e.charAt(W), w = null, !B) {
					if (!0 === C[m]) w = m, W++, G++;
					else {
						for (a = ""; W < V && (m = e.charAt(W), i(m));) a += m, W++;
						m = e.charAt(W), W++, a && !0 === o[m] && (w = m, G += a.length + 1)
					}
					if (w)
						if ((m = e.charAt(W)) === d) G += y - G % y, W++;
						else if (m === p) {
						for (U = W + y; W < U && e.charAt(W) === p;) W++, G++;
						W === U && e.charAt(W) === p && (W -= y - 1, G -= y - 1)
					} else m !== h && "" !== m && (w = null)
				}
				if (w) {
					if (!Y && g !== w) break;
					_ = !0
				} else F || B || e.charAt(b) !== p ? F && D && (B = G >= D.indent || G > y) : B = !0, _ = !1, W = b;
				if (A = e.slice(b, v), k = b === W ? A : e.slice(W, v), (w === c || w === l || w === f) && q.thematicBreak.call(this, t, A, !0)) break;
				if (S = T, T = !r(k).length, B && D) D.value = D.value.concat(O, A), N = N.concat(O, A), O = [];
				else if (_) 0 !== O.length && (D.value.push(""), D.trail = O.concat()), D = {
					value: [A],
					indent: G,
					trail: []
				}, I.push(D), N = N.concat(O, A), O = [];
				else if (T) {
					if (S) break;
					O.push(A)
				} else {
					if (S) break;
					if (u(H, q, this, [t, A, !0])) break;
					D.value = D.value.concat(O, A), N = N.concat(O, A), O = []
				}
				W = v + 1
			}
			L = t(N.join(h)).reset({
				...
				loose: null,
				children: []
			}), P = this.enterList(), j = this.enterBlock(), R = !1, W = -1, V = I.length;
			for (; ++W < V;) D = I[W].value.join(h), z = t.now(), (D = t(D)(x(this, D, z), L)).loose && (R = !0), D = I[W].trail.join(h), W !== V - 1 && (D += h), t(D);
		...
		function x(t, e, n) {
			var r, o, i = t.offset,
				a = null;
			return e = (t.options.pedantic ? k : A).apply(null, arguments), t.options.gfm && (r = e.match(v)) && (o = r[0].length, a = r[1].toLowerCase() === m, i[n.line] += o, e = e.slice(o)), {
				type: "listItem",
				loose: g.test(e) || e.charAt(e.length - 1) === h,
				checked: a,
		...
		function A(t, e, n) {
			...
			for (c = (e = e.replace(b, function(t, e, n, a, s) {
				...
				})).split(h), (l = s(e, a(r).indent).split(h))[0] = u, m[y] = (m[y] || 0) + i.length, y++, f = 0, d = c.length; ++f < d;) m[y] = (m[y] || 0) + c[f].length - l[f].length, y++;
			return l.join(h)
		}
		M["."] = !0, M[")"] = !0
	}, function(t, e, n) {
		...
		t.exports = function(t, e, n) {
			var l, f, p, h, d = -1,
				m = e.length + 1,
				y = "";
			for (; ++d < m && ((l = e.charAt(d)) === o || l === i);) y += l;
			if (l !== a && l !== u && l !== s) return;
			f = l, y += l, p = 1, h = "";
			for (; ++d < m;)
				if ((l = e.charAt(d)) === f) p++, y += h + f, h = "";
				else {
					if (l !== i) return p >= c && (!l || l === r) ? (y += h, !!n || t(y)({
						type: "thematicBreak"
					})) : void 0;
					h += l
				}
		...
		t.exports = function(t, e, n) {
			...
			return d.column += m.length, d.offset += m.length, t(m += y + c)({
				type: "heading",
				depth: l,
				children: this.tokenizeInline(y, d)
			})
		};
		var r = "\n",
			o = "\t",
		...
		var r = n(24),
			o = n(54);
		t.exports = function(t, e, n) {
			var c, l, f, p, h, d, m, y, g, v = this.offset,
				b = this.blockTokenizers,
				...
				k = [],
				A = 0;
			for (; A < E && ((l = e.charAt(A)) === s || l === a);) A++;
			if (e.charAt(A) !== u) return;
			if (n) return !0;
			A = 0;
			for (; A < E;) {
				for (p = e.indexOf(i, A), m = A, y = !1, -1 === p && (p = E); A < E && ((l = e.charAt(A)) === s || l === a);) A++;
				if (e.charAt(A) === u ? (A++, y = !0, e.charAt(A) === s && A++) : A = m, h = e.slice(A, p), !y && !r(h)) {
					A = m;
					break
				}
				if (!y && (f = e.slice(A), o(_, b, this, [t, f, !0]))) break;
				d = m === A ? h : e.slice(m, p), k.push(A - m), M.push(d), x.push(h), A = p + 1
			}
			A = -1, E = k.length, c = t(M.join(i));
			for (; ++A < E;) v[C] = (v[C] || 0) + k[A], C++;
			return g = this.enterBlock(), x = this.tokenizeBlock(x.join(i), w), g(), c({
				type: "blockquote",
				children: x
			})
		};
		...
		var r = n(55);
		t.exports = function(t, e, n) {
			var f, p, h, d, m, y, g, v, b, _, w, C = this.options,
				E = e.length + 1,
				M = 0,
				x = "";
			if (!C.gfm) return;
			...
			m = "", v = "", b = "", y = "", g = "";
			for (; M < E;)
				if (h = e.charAt(M), y += v, g += b, v = "", b = "", h === o) {
					for (y ? (v += h, b += h) : x += h, m = "", M++; M < E && (h = e.charAt(M)) === a;) m += h, M++;
		...
		t.exports = function(t, e, n) {
			...
			for (; ++f < p;)
				if (r = e.charAt(f), l)
					if (l = !1, h += m, d += y, m = "", y = "", r === i) m = r, y = r;
					else
						for (h += r, d += r; ++f < p;) {
							if (!(r = e.charAt(f)) || r === i) {
								y = r, m = r;
		...
		t.exports = function(t) {
			return function(e, n) {
				...
				function v(t) {
					for (var e = -1, n = t.indexOf("\n"); - 1 !== n;) y++, e = n, n = t.indexOf("\n", n + 1); - 1 === e ? g += t.length : g = t.length - e, y in p && (-1 !== e ? g += p[y] : g <= p[y] && (g = p[y] + 1))
				}
				...
				function w(t) {
					var n = function() {
							var t = [],
								e = y + 1;
							return function() {
								for (var n = y + 1; e < n;) t.push((p[e] || 0) + 1), e++;
								return t
							}
						}(),
						i = _(),
					...
					function u() {
						...
						return y = a.line, g = a.column, e = t + e, n
					}

					function c() {
						var n = i({});
						return y = a.line, g = a.column, e = t + e, n.position
					}
				}
			}
		};
		...
		l.setOptions = n(225), l.parse = n(222), l.options = n(96), l.exitStart = o("atStart", !0), l.enterList = o("inList", !1), l.enterLink = o("inLink", !1), l.enterBlock = o("inBlock", !1), l.interruptParagraph = [
			["thematicBreak"],
			["atxHeading"],
			["fencedCode"],
			["blockquote"],
		...
		t.exports = function t() {
			...
			w.stringify = function(t, e) {
				var n, r = i(e);
				if (C(), d("stringify", n = w.Compiler), y(t), p(n)) return new n(t, r).compile();
				return n(t, r)
			};
			w.run = E;
			...
			function E(t, e, r) {
				if (y(t), C(), r || "function" != typeof e || (r = e, e = null), !r) return new Promise(o);
			...
			v = function(t) {
				...
				var n = o(m, t.renderers),
					...
					d = function(t) {
						var e = [p, u()],
							n = t.disallowedTypes;
						t.allowedTypes && (n = g.filter(function(e) {
						...
						var o = !t.escapeHtml && !t.skipHtml,
							i = (t.astPlugins || []).some(function(t) {
								...
								return e.identity === y.HtmlParser
							});
						o && !i && e.push(c);
		...
		v.defaultProps = {
			...
			skipHtml: s.bool,
			allowNode: s.func,
			allowedTypes: s.arrayOf(s.oneOf(g)),
			disallowedTypes: s.arrayOf(s.oneOf(g)),
			...
			renderers: s.object,
			plugins: s.array
		}, v.types = g, v.renderers = m, v.uriTransformer = d, t.exports = v
	}, function(t, e, n) {
		(e = t.exports = n(11)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".imageFrame {\n  width: 300px;\n  height: 200px;\n  margin-top: 10px; }\n", ""])
	}, function(t, e, n) {
		var r = n(254);
		"string" == typeof r && (r = [
			[t.i, r, ""]
		...
		(e = t.exports = n(11)(!1)).push([t.i, "@import url(https://fonts.googleapis.com/css?family=Roboto);", ""]), e.push([t.i, ".videoFrame {\n  width: 300px;\n  height: 200px;\n  margin-top: 10px;\n  border: none; }\n", ""])
	}, function(t, e, n) {
		var r = n(257);
		"string" == typeof r && (r = [
			[t.i, r, ""]
		...
		var p = function() {
			...
			h = function(t) {
				function e() {
					...
					return n = o = f(this, (t = e.__proto__ || Object.getPrototypeOf(e)).call.apply(t, [this].concat(s))), o.getComponentToRender = function(t, e, n) {
		...
		var l = function(t) {
			...
			var n = void 0 !== t.showCloseButton ? t.showCloseButton : !t.fullScreenMode && !t.embedded;
			return o.default.createElement("div", {
				className: e.join(" ")
			}, (t.fullScreenMode || t.showChat || t.embedded) && o.default.createElement(s.default, r({
				title: t.title,
				subtitle: t.subtitle,
				...
				showCloseButton: n
			})), !t.fullScreenMode && !t.embedded && o.default.createElement(u.default, {
		...
		l.propTypes = {
			...
			onToggleConversation: a.default.func,
			showChat: a.default.bool,
			...
			return function(t, e) {
				...
				value: function() {
					...
					this.props.socket.on("bot_uttered", function(e) {
						t.messages.push(e)
					}), (this.props.embedded || this.props.fullScreenMode) && this.toggleConversation()
				}
			}, {
				key: "dispatchMessage",
				value: function(t) {
		...
		var _ = 1,
			w = {
				...
				mountComponent: function(t, e, n, o) {
					...
					}(l) ? this._compositeType = m : this._compositeType = y : (a = d, b(), null === d || !1 === d || i.isValidElement(d) || r("105", l.displayName || l.name || "Component"), d = new v(l), this._compositeType = g), d.props = s, d.context = u, d.refs = p, d.updater = f, this._instance = d, c.set(d, this);
					var w, C = d.state;
				...
				updateComponent: function(t, e, n, o, i) {
					...
					var f = this._processPendingState(l, s),
						p = !0;
					this._pendingForceUpdate || (a.shouldComponentUpdate ? p = a.shouldComponentUpdate(l, f, s) : this._compositeType === y && (p = !h(c, l) || !h(a.state, f))), this._updateBatchNumber = null, p ? (this._pendingForceUpdate = !1, this._performComponentUpdate(n, l, f, s, t, i)) : (this._currentElement = n, this._context = i, a.props = l, a.state = f, a.context = s)
				},
						...
						for (p in e)
							if (e.hasOwnProperty(p)) {
								...
								if (null != h && i(d, m)) r.receiveComponent(h, m, s, l), e[p] = h;
									...
									var y = o(m, !0);
									e[p] = y;
									var g = r.mountComponent(y, s, u, c, l, f);
									n.push(g)
								}
							}
					...
					if (s || r) {
						...
						for (l in s)
							if (s.hasOwnProperty(l)) {
								var y = r && r[l],
									g = s[l];
								y === g ? (f = u(f, this.moveChild(y, m, p, h)), h = Math.max(y._mountIndex, h), y._mountIndex = p) : (y && (h = Math.max(y._mountIndex, h)), f = u(f, this._mountChildAtIndex(g, a[d], m, p, e, n)), d++), p++, m = i.getHostNode(g)
							}
		...
		function P(t, e, n, r) {
			if (!(r instanceof w)) {
				...
				A(e, i), r.getReactMountReady().enqueue(j, {
					inst: t,
					registrationName: e,
					listener: n
				})
		...
		function Z(t) {
			var e = t.type;
			! function(t) {
				G.call(Q, t) || (V.test(t) || r("65", t), Q[t] = !0)
		...
		Z.displayName = "ReactDOMComponent", Z.Mixin = {
			mountComponent: function(t, e, n, r) {
				...
				switch (this._tag) {
					...
					case "video":
						...
						break;
					case "input":
						y.mountWrapper(this, f, e), f = y.getHostProps(this, f), t.getReactMountReady().enqueue(B, this), t.getReactMountReady().enqueue(F, this);
						break;
					case "option":
						g.mountWrapper(this, f, e), f = g.getHostProps(this, f);
						break;
					case "select":
			...
			_createOpenTagMarkupAndPutListeners: function(t, e) {
				...
				for (var r in e)
					if (e.hasOwnProperty(r)) {
						var i = e[r];
						if (null != i)
							if (S.hasOwnProperty(r)) i && P(this, r, i, t);
							else {
			...
			updateComponent: function(t, e, n, r) {
				...
				switch (D(this, i), this._updateDOMProperties(o, i, t), this._updateDOMChildren(o, i, t, r), this._tag) {
					case "input":
						y.updateWrapper(this), E.updateValueIfChanged(this);
						break;
					case "textarea":
			...
			_updateDOMProperties: function(t, e, n) {
				...
				for (r in t)
					if (!e.hasOwnProperty(r) && t.hasOwnProperty(r) && null != t[r])
						...
						} else S.hasOwnProperty(r) ? t[r] && x(this, r) : K(this._tag, t) ? N.hasOwnProperty(r) || l.deleteValueForAttribute(k(this), r) : (c.properties[r] || c.isCustomAttribute(r)) && l.deleteValueForProperty(k(this), r);
				for (r in e) {
					var f = e[r],
					...
					else if (S.hasOwnProperty(r)) f ? P(this, r, f, n) : p && x(this, r);
					else if (K(this._tag, e)) N.hasOwnProperty(r) || l.setValueForAttribute(k(this), r, f);
		...
		var r = n(70),
			o = {
				processChildrenUpdates: n(350).dangerouslyProcessChildrenUpdates,
		...
		var r = n(33),
			...
			s = {
				...
				extractEvents: function(t, e, n, s) {
					...
					return y.type = "mouseenter", y.target = d, y.relatedTarget = h, r.accumulateEnterLeaveDispatches(m, y, c, l), [m, y]
				}
			};
		t.exports = s
	}, function(t, e, n) {
		...
		function _() {
			m && (m.detachEvent("onchange", v), m = null, y = null)
		}
		...
		function E(t, e, n) {
			"topFocus" === t ? (_(), function(t, e) {
				y = e, (m = t).attachEvent("onchange", v)
			}(e, n)) : "topBlur" === t && _()
		}
		...
		function k(t) {
			"value" === t.propertyName && w(y, t) && v(t)
		}

		function A(t, e, n) {
			"topFocus" === t ? (x(), function(t, e) {
				y = e, (m = t).attachEvent("onpropertychange", k)
			}(e, n)) : "topBlur" === t && x()
		}

		function S(t, e, n) {
			if ("topSelectionChange" === t || "topKeyUp" === t || "topKeyDown" === t) return w(y, n)
		}
		...
		var N = {
			...
			extractEvents: function(t, e, n, r) {
				...
				if ("select" === (u = (s = c).nodeName && s.nodeName.toLowerCase()) || "input" === u && "file" === s.type ? g ? o = C : i = E : p(c) ? M ? o = I : (o = S, i = A) : function(t) {
						var e = t.nodeName;
		...
		var p, h = o.canUseDOM && "TextEvent" in window && !f && !("object" == typeof(p = window.opera) && "function" == typeof p.version && parseInt(p.version(), 10) <= 12),
			d = o.canUseDOM && (!l || f && f > 8 && f <= 11);
		var m = 32,
		...
		t.exports = {
			inject: function() {
				C || (C = !0, g.EventEmitter.injectReactEventListener(y), g.EventPluginHub.injectEventPluginOrder(a), g.EventPluginUtils.injectComponentTree(f), g.EventPluginUtils.injectTreeTraversal(h), g.EventPluginHub.injectEventPluginsByName({
					SimpleEventPlugin: w,
					...
					return new p(t)
				}), g.Updates.injectReconcileTransaction(v), g.Updates.injectBatchingStrategy(m), g.Component.injectEnvironment(c))
			}
		}
	}, function(t, e, n) {
		"use strict";
		...
		t.exports = function(t, e, n) {
						...
						if (n.hasOwnProperty(s) && s !== a) {
							...
							if (f(p, s), l.hasOwnProperty(s)) l[s](t, c);
								...
								if ("function" != typeof c || h || p || !1 === n.autobind)
									if (p) {
										var y = u[s];
										i(h && ("DEFINE_MANY_MERGED" === y || "DEFINE_MANY" === y), "ReactClass: Unexpected spec policy %s for key %s when mixing in component specs.", y, s), "DEFINE_MANY_MERGED" === y ? r[s] = d(r[s], c) : "DEFINE_MANY" === y && (r[s] = m(r[s], c))
									} else r[s] = c;
			...
			return r(_.prototype, t.prototype, b),
				function(t) {
					...
					for (var r in e.prototype = new _, e.prototype.constructor = e, e.prototype.__reactAutoBindPairs = [], s.forEach(p.bind(null, e)), p(e, g), p(e, t), p(e, v), e.getDefaultProps && (e.defaultProps = e.getDefaultProps()), i(e.prototype.render, "createClass(...): Class specification must implement a `render` method."), u) e.prototype[r] || (e.prototype[r] = null);
					return e
				}
		}
	}, function(t, e, n) {
		...
		t.exports = function(t, e) {
			...
			function d(t) {
				return h(function(e, n, r, o, i, a) {
					var s = e[n];
					return y(s) !== t ? new p("Invalid " + o + " `" + i + "` of type `" + g(s) + "` supplied to `" + r + "`, expected `" + t + "`.") : null
				})
			}
